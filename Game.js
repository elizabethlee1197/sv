class Game {
  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      textSize(25);
      fill("white");
      text("player 1 lives:3"+allPlayers.player1.lives,50,50);
      text("player 2 lives:3"+allPlayers.player2.lives,50,100);
      text("player 3 lives:3"+allPlayers.player3.lives,50,150);
      text("player 4 lives:3"+allPlayers.player4.lives,50,200);
...
if (frameCount%200===0){
  ...
  switch(rand){
  case 1:coin.addImage("coin",obstacle1_img);
  break;
